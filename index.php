...
<head>
    ...
    <title>JOB PORTAL BY Aqil</title>
...
<!-- Page (2 columns) -->
    ...
    <div id="page-in" class="box">
        ...
        <div id="content">
            ...
            <!-- Article -->
            <div class="article">
                <h2><span><a href="#">Welcome To Job Portal System developed by Aqil </a></span></h2>
				<h3><marquee>Welcome To Job Portal System developed by Aqil </marquee></h3>
